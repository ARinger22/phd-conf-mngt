    ...
    <div>
      <Paper className="item-center">
        ...
        <div style={{ textAlign: "center", fontSize: "24px" }}>
          <h2>
            <u>
              <b>PART B: INFORMATION ABOUT THE CONFERENCE/ SYMPOSIUM</b>
            </u>
          </h2>
        </div>
        <br></br>
        <Container>
          <div className={classes.form}>
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                <pre>
                  1. Title of the conference/symposium:{" "}
                  <b>{data?.nameOfConference} </b>
                </pre>
                <pre>
                  {" "}
                  Name of the society/school/workshop/conference/short term
                  course etc organizing the conference:{" "}
                  <b>{data?.nameOfSociety}</b>{" "}
                </pre>
                <pre>
                  {" "}
                  Is the conference organized by the recognized scientific
                  society/school/workshop/conference/short term course etc:{" "}
                  <b>Yes</b>{" "}
                </pre>
                <br></br>
                <pre>
                  {" "}
                  a. Venue : <b>{data?.venueOfConference}</b>
                </pre>
                <pre>
                  {" "}
                  b. Period of the event: <b>
                    {data?.conferenceStarts}
                  </b> to <b>{data?.conferenceEnds}</b>
                </pre>
                <pre>
                  {" "}
                  c. Period of the connected visits (if any): <b>N/A</b>
                </pre>
                <pre>
                  {" "}
                  d. Purpose of the visit (Please tick mark):{" "}
                  <b>{data?.purposeOfVisit}</b>{" "}
                </pre>
                <pre>
                  {" "}
                  [\/] Presenting a paper Oral/Poster(please specify):{" "}
                </pre>
            ...
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                <pre>
                  2. Why would you like to attend this conference and what is
                  its relevance with your PhD thesis:{" "}
                  <b>{user?.purposeOfVisit}</b>{" "}
                </pre>
              </Grid>
            </Grid>
            ...
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                <pre>
                  3. Itinerary/Flight details (arrival & departure to the place
                  of conference):{" "}
                </pre>
              </Grid>
            </Grid>
                ...
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell style={{ fontSize: "16px" }}>
                      <p>
                        Departure [Time/date]:{" "}
                        <b>{data?.flightDetails[0].destination} </b>
                      </p>
                    </TableCell>
                    <TableCell style={{ fontSize: "data" }}>
                      <p>
                        Arrival: <b>{data?.flightDetails[0].arrival} </b>
                      </p>
                    </TableCell>
                  </TableRow>
                </TableHead>
        ...
        <Container>
          <div className={classes.form}>
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                <pre>
                  4. Whether applied to DST/DBT/INSA/other funding sources? :No
                </pre>
            ...
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                <pre>
                  6. Duty leave required from <b>{data?.studentLeaveStarts}</b>{" "}
                  to <b>{data?.studentLeaveEnds}</b>{" "}
                </pre>
              </Grid>
              <br />
              <Grid item xs={5}>
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell style={{ fontSize: "16px" }}>
                        <b>Period: </b>
                        <b>{data?.conferenceStarts}</b> to{" "}
                        <b>{data?.conferenceEnds}</b>
                      </TableCell>
                      <TableCell style={{ fontSize: "16px" }}>
                        <b>Purpose: </b>
                        {data?.purposeOfVisit}
        ...
        <Container>
          <div className={classes.form}>
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                <pre>
                  8. Whether the report(s) on above visits were submitted? If
                  yes, please enclose a copy of the last: <b>No</b>
                </pre>
            ...
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                <pre>
                  9. Financial support required (if any) from institute fund/
                  project/ any other (please specify)
                </pre>
                <pre>..............................</pre>
        ...
        <div style={{ textAlign: "center" }}>
          <h2 style={{ fontSize: "24px" }}>
            <u>
              <b>PART C: SUPPORTING DOCUMENTS</b>
            </u>
          </h2>
          <br />
          <h3 style={{ fontSize: "20px" }}>
            Following documents, to be attached along with the proforma while
          ...
          <div className={classes.form}>
            <Grid className="py-2" container spacing={2}>
              <Grid item xs={7}>
                ...
                <pre>
                  c. [] Conference brochure with registration fee detail Flag
                  'C'
                </pre>
          ...
          <div className={classes.form}>
            <div style={{ border: "2px solid black", padding: "10px" }}>
              ...
              <Grid className="py-2" container spacing={2}>
                <Grid item xs={7}>
                  <pre>
                    Balance Available <b>Rs.{user?.balance}</b>
                  </pre>
                </Grid>
              </Grid>
