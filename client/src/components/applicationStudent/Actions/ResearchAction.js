        ...
        <>
          <div className=" mt-2 bg-white shadow sm:rounded-lg">
            <div className="px-4 py-2 sm:px-6">
              <h3 className="flex justify-center items-center font-bold text-2xl leading-6 text-gray-900">
                Take Action
              </h3>
            </div>
              ...
              <dl>
                <div className="bg-gray-50 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                    <input
                      ...
                      onChange={getGrant}
                      placeholder=""
                      className="block  mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-blue-400 bg-white px-5 py-2.5 text-gray-700 focus:border-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-40 dark:border-red-400 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-red-300"
                    />
                  </dd>
                </div>
                ...
                <div className="bg-gray-50  px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd className="mt-1 w-full  text-sm text-gray-900 sm:mt-0">
                    <textarea
                      onChange={getRemarks}
                      className="block  mt-2 w-auto  placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-200 bg-white px-4 h-32 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300"
                    />
                  </dd>
                </div>
