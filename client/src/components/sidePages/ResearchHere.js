                    ...
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-3">
                        <div className="rounded-xl overflow-hidden shadow-md flex flex-col">
                            ...
                            <div className="p-6 bg-white dark:bg-gray-800 flex flex-col justify-between">
                                ...
                                <a href="https://iitrpr.ac.in/covid-19-inventionssolutions" className="block text-center py-2 px-4 text-white rounded-full transition duration-300 ease-in-out bg-dark-purple hover:text-teal-400 hover:bg-button-hover-blue">
                                    Navigate
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl overflow-hidden shadow-md flex flex-col">
                            ...
                            <div className="p-6 bg-white dark:bg-gray-800 flex flex-col justify-between">
                                ...
                                <a href="https://iitrpr.ac.in/research-highlights" className="block text-center py-2 px-4  text-white rounded-full transition duration-300 ease-in-out bg-dark-purple hover:text-teal-400 hover:bg-button-hover-blue">
                                    Navigate
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl overflow-hidden shadow-md flex flex-col">
                            ...
                            <div className="p-6 bg-white dark:bg-gray-800 flex flex-col justify-between">
                                ...
                                <a href="https://iitrpr.ac.in/research-iitrpr" className="block text-center py-2 px-4 text-white rounded-full transition duration-300 ease-in-out bg-dark-purple hover:text-teal-400 hover:bg-button-hover-blue">
                                    Navigate
                                </a>
                            </div>
                        </div>
