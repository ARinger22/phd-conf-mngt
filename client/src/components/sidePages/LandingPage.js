  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl py-12 sm:py-24 lg:py-34">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              A portal for Managing your conference grant applications easily and efficiently.
            </p>
        ...
        <div className="absolute inset-x-0 top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
          <svg
            className="relative right-[calc(50%-11rem)] -z-10 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-30rem)] sm:h-[42.375rem]"
            viewBox="0 0 1155 678"
          >
            <path
              fill="url(#45de2b6b-92d5-4d68-a6a0-9b9b2abad533)"
