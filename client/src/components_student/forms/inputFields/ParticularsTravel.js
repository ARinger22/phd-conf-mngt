        ...
        <>
            ...
            <div className="mt-6 flex items-center justify-end gap-x-6">
                <button
                    ...
                    className="rounded-md bg-dark-purple hover:text-teal-400 hover:bg-button-hover-blue px-3 py-2 text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dark-purple"
                >
                    ADD
                </button>
            </div>
