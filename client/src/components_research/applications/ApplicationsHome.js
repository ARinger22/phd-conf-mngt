                    ...
                    <div className="">
                        ...
                        <div className="pb-4 flex items-center space-x-4">
                            ...
                            <button type="button" name={item._id}
                                onClick={viewSpecficApplication} className="inline-flex items-center text-white  focus:ring-4 focus:outline-none focus:ring-dark-purple bg-dark-purple hover:text-teal-400 hover:bg-button-hover-blue font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">
